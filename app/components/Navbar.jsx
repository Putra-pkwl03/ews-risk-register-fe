...
export default function Navbar({ toggleSidebar }) {
  ...
  return (
    <nav className="bg-white shadow px-2 py-1 flex items-center justify-end sticky top-0 z-40" style={{ minHeight: '40px' }}>
    <div className="flex items-center gap-2 relative" ref={dropdownRef}>
  
      <div className="text-center text-md sm:text-sm leading-tight text-gray-700 max-w-[120px] truncate">
